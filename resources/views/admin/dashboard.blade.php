                                        ...
                                        <tr>
                                            <td class="ps-0">
                                                <div class="d-flex align-items-center gap-3">
                                                    <div class="flex-shrink-0">
                                                        <img src="../assets/images/products/product-1.jpg" class="rounded"
                                                            alt="p1" width="80" />
                                                    </div>
                                                    <div>
                                                        <h6 class="mb-0 fw-semibold">Irpun Wicaksono
                                                        </h6>
                                            ...
                                            <td class="text-end ps-0">
                                                <span class="badge bg-warning-subtle text-warning rounded-pill">
                                                    <span
                                                        class="round-8 text-bg-warning rounded-circle d-inline-block me-1"></span>progress
                                                </span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="ps-0">
                                                <div class="d-flex align-items-center gap-3">
                                                    <div class="flex-shrink-0">
                                                        <img src="../assets/images/products/product-2.jpg" class="rounded"
                                                            alt="p2" width="80" />
                                                    </div>
                                                    <div>
                                                        <h6 class="mb-0 fw-semibold">Oyhan Ruhiyan
                                                        </h6>
                                            ...
                                            <td class="text-end ps-0">
                                                <span class="badge bg-success-subtle text-success rounded-pill">
                                                    <span
                                                        class="round-8 text-bg-success rounded-circle d-inline-block me-1"></span>delivered
                                                </span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="ps-0">
                                                <div class="d-flex align-items-center gap-3">
                                                    <div class="flex-shrink-0">
                                                        <img src="../assets/images/products/product-3.jpg" class="rounded"
                                                            alt="p3" width="80" />
                                                    </div>
                                                    <div>
                                                        <h6 class="mb-0 fw-semibold">Dayat Santoso
                                                        </h6>
                                            ...
                                            <td class="text-end ps-0">
                                                <span class="badge bg-danger-subtle text-danger rounded-pill">
                                                    <span
                                                        class="round-8 text-bg-danger rounded-circle d-inline-block me-1"></span>cancel
                                                </span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="ps-0">
                                                <div class="d-flex align-items-center gap-3">
                                                    <div class="flex-shrink-0">
                                                        <img src="../assets/images/products/product-4.jpg" class="rounded"
                                                            alt="p4" width="80" />
                                                    </div>
                                                    <div>
                                                        <h6 class="mb-0 fw-semibold">Irpun Wicaksono
            ...
            <div class="card w-100">
                <div class="card-body">
                    ...
                    <div class="mt-4 pb-3 border-bottom">
                        ...
                        <span class="fs-3 lh-sm">Designing an NFT-themed website with a creative
                            concept so th...</span>
                        <div class="hstack gap-3 mt-3">
                            ...
                            <a href="#" class="fs-3 text-bodycolor d-flex align-items-center text-decoration-none">
                                <i class="ti ti-message-dots fs-6 text-primary me-2 d-flex"></i> 13
                                Commets </a>
                        </div>
                    </div>
                    <div class="py-3 border-bottom">
                        ...
                        <div class="hstack gap-3 mt-3">
                            ...
                            <a href="#" class="fs-3 text-bodycolor d-flex align-items-center text-decoration-none">
                                <i class="ti ti-message-dots fs-6 text-primary me-2 d-flex"></i> 50
                                Commets </a>
                        </div>
                    </div>
                    <div class="pt-3">
                        ...
                        <div class="hstack gap-3 mt-3">
                            ...
                            <a href="#" class="fs-3 text-bodycolor d-flex align-items-center text-decoration-none">
                                <i class="ti ti-message-dots fs-6 text-primary me-2 d-flex"></i> 12
                                Commets </a>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="hstack">
                                <a href="javascript:void(0)" data-bs-toggle="tooltip" data-bs-placement="top"
                                    ...
                                    <img src="../assets/images/profile/user-1.jpg"
                                        class="rounded-circle  border-2 border-white" width="35"
                                        alt="u1" />
                                </a>
                                <a href="javascript:void(0)" data-bs-toggle="tooltip" data-bs-placement="top"
                        ...
                        <div class="col-md-6">
                            <div class="hstack p-3 border rounded mb-3 mb-md-0">
                                <a href="javascript:void(0)" data-bs-toggle="tooltip" data-bs-placement="top"
                                    title="John Deo">
                                    <img src="../assets/images/profile/user-1.jpg"
                                        class="rounded-circle  border-2 border-white" width="30"
                                        alt="u4" />
                                </a>
                                <a href="javascript:void(0)" data-bs-toggle="tooltip" data-bs-placement="top"
                                    title="Mark Smith" class="ms-n2">
